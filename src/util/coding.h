...
bool GetFixed16(std::span<const std::byte> input, std::size_t offset,
                std::uint16_t& value);
bool GetFixed32(std::span<const std::byte> input, std::size_t offset,
                std::uint32_t& value);
bool GetFixed64(std::span<const std::byte> input, std::size_t offset,
                std::uint64_t& value);
