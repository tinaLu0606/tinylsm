...
if(NOT DEFINED INPUT OR INPUT STREQUAL "")
  message(FATAL_ERROR "usage: cmake -DINPUT=<benchmark.json> -P scripts/verify_write_benchmark_json.cmake")
endif()
if(NOT EXISTS "${INPUT}")
...
set(expected_names TinyLSM/WriteFlushLatencyAsync TinyLSM/WriteFlushLatencySync)
set(found_names "")
